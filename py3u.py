...
def logo():
    ...
    print("\033[94m│    \033[92m▘  ▗▄▘▀▀▘▘ ▘▝▀ ▘  ▗▄▘▌   ▀ ▝▀ ▘  \033[94m   │".center(column1))
    print("\033[94m│                                        │".center(column2))
    print("\033[94m│ \033[95mAuthor : Md Suman Hossain                     \033[94m│".center(column1))
    print("\033[94m│ \033[95mTool   : Encode Python2 and Python3    \033[94m│".center(column1))
    print("\033[94m│ \033[95mGitHub : https://github.com/suman6382864 \033[94m│".center(column1))
    print("\033[94m│ \033[95mCoder  : MD SUMAN HOSSAIN              \033[37mV2.0 \033[94m│".center(column3))
    print("\033[94m└────────────────────────────────────────┘".center(column2))
...
def logout():
    ...
    print("\033[93m[ \033[92https://github.com/suman6382864/ \033[93m]\033[37m\n".center(column3))
    sys.exit()
...
marshalHead = "# Encoded By Suman\n# A Product Of Md Sumsn Hossain\n# https://github.com/suman6382864\n\nimport marshal\n\nexec(marshal.loads("

marshalTail = "))"

#Base64_Code_Executor#
b64Head = "# Encoded By Suman\n# A Product Of Md Suman Hossain\n# https://github.com/suman6382864\n\nimport base64\n\nexec(base64.b64decode("

b64Tail = "))"

#Zlib_Code_Executor#
zlibHead = "# Encoded By Suman\n# A Product Of Md Suman Hossain\n# https://github.com/suman6382864\n\nimport zlib\n\nexec(zlib.decompress("

zlibTail = "))"

#Zlib+B64+Mar_Code_Executor#
allHead = "# Encoded By Suman\n# A Product Of Md Suman Hossain\n# https://github.com/suman6382864\n\nimport marshal, base64, zlib\n\nexec(marshal.loads(zlib.decompress(base64.b64decode("
...
def update():
    ...
    try:
        mainVersion = requests.get("https://raw.githubusercontent.com/suman6382864/pycode3/main/vas").text
    except:
    ...
    if (toolVersion == mainVersion):
        ...
        time.sleep(1)
        os.system("cd .. && cd PyEncryptor && python Py3u.py")
